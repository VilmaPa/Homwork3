    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            if ((httpResponse.StatusCode == System.Net.HttpStatusCode.OK)&&(httpResponse2.StatusCode == System.Net.HttpStatusCode.OK)&&(httpResponse3.StatusCode == System.Net.HttpStatusCode.OK))
            {
                    ...
                    var DennisUserId = users.Where(u => u.Name == "Mrs. Dennis Schulist").Select(u => u.Id).FirstOrDefault();
                ...
                //result is list
                    var filteredAlbumId = albums.Where(a => a.UserId == DennisUserId).Select(a => a.Id).ToList();
